...
export default function Root({
  ...
  return (
    <table className="min-[517px]:w-fit flex max-h-[50vh] min-h-64 cursor-default flex-col overflow-auto rounded-lg border-2 border-neutral-400 capitalize dark:border-neutral-500">
